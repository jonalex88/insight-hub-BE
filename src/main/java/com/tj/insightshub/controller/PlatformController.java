...
public class PlatformController {
    ...
    private static final String AREA = "Platforms";
    private final PaymentMethodRepository repo;

    public PlatformController(PaymentMethodRepository repo) {
        this.repo = repo;
    }

    @GetMapping
    public List<Map<String, Object>> list() { return repo.findAll(AREA); }

    @GetMapping("/stats/30d")
    public List<Map<String, Object>> stats30d() { return repo.stats30d(AREA); }
