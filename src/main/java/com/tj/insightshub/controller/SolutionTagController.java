...
import com.tj.insightshub.repository.SolutionTagRepository;
...
@RestController
@RequestMapping("/api/v1/solution-tags")
public class SolutionTagController {

    private final SolutionTagRepository repo;

    public SolutionTagController(SolutionTagRepository repo) {
        this.repo = repo;
    }
    ...
    public ResponseEntity<?> create(@RequestBody Map<String, Object> body) {
        ...
        return ResponseEntity.status(201).body(
                repo.create(id, name.trim(), shortName, tag, logo, description));
    }
